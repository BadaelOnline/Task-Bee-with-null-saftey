...
class CashReports extends StatefulWidget {
  const CashReports({Key? key}) : super(key: key);

  @override
  _CashReportsState createState() => _CashReportsState();
}

class _CashReportsState extends State<CashReports> {
  int? walletId;
  String? walletName;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBar(
        ...
        "${getLang(context, "Reports Cash Wallet")}",
