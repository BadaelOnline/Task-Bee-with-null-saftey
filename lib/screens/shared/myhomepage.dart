              ...
              children: [
                Container(
                  ...
                  child:CustomRaisdButton(
                    text:'Wallet' ,
                    onPressed:() => Navigator.of(context).pushNamed('/walletHome')),
                ) ,
                SizedBox(
                ...
                Container(
                  ...
                  child: CustomRaisdButton(
                      text: 'Currency',
                      onPressed: () => Navigator.of(context).pushNamed('/currencyHome')),
                  //   TextButton(
                ...
                Container(
                  ...
                  child: CustomRaisdButton(
                      text: 'Exchange',
                      onPressed: () => Navigator.of(context).pushNamed('/exchangeHome')),
                  // TextButton(
                  //     onPressed: () => Navigator.push(context,
                ...
                Container(
                  ...
                  child: CustomRaisdButton(
                      text: 'Contact',
                      onPressed: () => Navigator.of(context).pushNamed('/contactHome')),
                  // TextButton(
                  //     onPressed: () => Navigator.push(context,
