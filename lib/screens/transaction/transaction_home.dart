                ...
                return BlocConsumer<CurrencyCubit, CurrencyStates>(
                  ...
                  builder: (context, state) {
                    return TransactionCard(
                        contact:
                            '${contactCubit.getContactName(contactId: transactionCubit.transactions![index].contactId)}',
                        datetime:
                        ...
                        imageWallet: Image.asset(
                            '${walletCubit.getWalletIconFromId(walletId: transactionCubit.transactions![index].walletId)}'),
                        ...
                        walletType:
                            '${walletCubit.getWalletName(walletId: transactionCubit.transactions![index].walletId)}',
                        currency:
                            '${currencyCubit.getCurrencyOfWallet(currencyId: walletCubit.getWalletCurrencyId(walletId: transactionCubit.transactions![index].walletId))}');
                  },
                );
              },
            ),
